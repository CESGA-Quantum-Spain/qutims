...
file = open('.shuffle_indices_'+str(rnd_seed)+'.csv', 'w')
file.close()
...
logdf = pd.DataFrame([{'jobID':job_id,  'cores':None, 'memory':None, 'CPU time':None, 'time':None, 'client': client_df,
                      ...
                      'rnd seed':rnd_seed, 'optimizer':optimizer_df, 'Nepochs':epochs, 'grad':False, 'shuffle':shuffle, 'LR':LR, 'Nshots':0}])
