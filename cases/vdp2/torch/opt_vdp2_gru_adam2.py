...
Description: this script creates the class and runs GRUModel training, running the samples (windows of the series) with HAND-MADE lines of code.
...
Sinput = 2; Shidden = 3; Sout = 1; Nlayers = 1

model = GRUModel(input_size=Sinput, hidden_size=Shidden, output_size=Sout, num_layers=Nlayers)
